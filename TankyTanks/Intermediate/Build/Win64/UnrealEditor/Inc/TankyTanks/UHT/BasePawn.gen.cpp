...
#include "TankyTanks/BasePawn.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeBasePawn() {}

// Begin Cross Module References
ENGINE_API UClass* Z_Construct_UClass_APawn();
TANKYTANKS_API UClass* Z_Construct_UClass_ABasePawn();
TANKYTANKS_API UClass* Z_Construct_UClass_ABasePawn_NoRegister();
UPackage* Z_Construct_UPackage__Script_TankyTanks();
...
UObject* (*const Z_Construct_UClass_ABasePawn_Statics::DependentSingletons[])() = {
	...
	(UObject* (*)())Z_Construct_UPackage__Script_TankyTanks,
};
...
template<> TANKYTANKS_API UClass* StaticClass<ABasePawn>()
{
	return ABasePawn::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_TankyTanks_Source_TankyTanks_BasePawn_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ABasePawn, ABasePawn::StaticClass, TEXT("ABasePawn"), &Z_Registration_Info_UClass_ABasePawn, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ABasePawn), 282883467U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TankyTanks_Source_TankyTanks_BasePawn_h_254683012(TEXT("/Script/TankyTanks"),
	Z_CompiledInDeferFile_FID_TankyTanks_Source_TankyTanks_BasePawn_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_TankyTanks_Source_TankyTanks_BasePawn_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
